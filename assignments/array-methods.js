...
// Problem 1
//Runners that donate over 200 are considered Golden Donors, and the director demands the list of all golden donors
let goldenDonors = runners.filter(runner => runner.donation > 200);
console.log(goldenDonors);

// Problem 2
//The director also requested for the runners' email addresses so that "Thank you for coming" mail can be send to them
let emailList = runners.map(runner => runner.email);
console.log(emailList);

// Problem 3
//The management also wants to know the total of golden donations
let goldenDonationTotal = goldenDonors.reduce((total, donor) => total + donor.donation, 0);
console.log(goldenDonationTotal);